...
<div class="ui center aligned segment">
  <div class="ui list">
    <div class="item">And lo, humble Nashville, with many a sound</div>
    <div class="item">Your Blues and your Gumbo were fine</div>
    <div class="item">And though there was rubble and butts all around</div>
    <div class="item">And tourists that came here to dine,</div>
    <div class="item">Your charm will be miss'd, and your spirit, which hit</div>
    <div class="item">Close to our hearts, you will find</div>
    <div class="item">Will not be forgotten (though chicken was rotten)</div>
    <div class="item">And will be at the back of our mind</div>
    <div class="item">We payed lots of cash at Museum Johnny Cash</div>
    <div class="item">And were lost like a book with no spine</div>
    <div class="item">But without a respite we're changing our site</div>
    <div class="item">Like a rabbit who forgot the time</div>
    <div class="item">And now we sit, our feet very sore</div>
    <div class="item">On the transport equivalent of one dollar stores</div>
  </div>
</div>
...
{% include multiimage.html description="Hanging around in Nashville." url1="/resources/us_roadtrip/nashville/sleeping.jpg" url2="/resources/us_roadtrip/nashville/river.jpg" url3="/resources/us_roadtrip/nashville/music_city_center.jpg" %}
...
{% include image.html description="Parthenon" url="/resources/us_roadtrip/nashville/parthenon.jpg" %}
...
{% include image.html description="Vanderbilt" url="/resources/us_roadtrip/nashville/vanderbilt.jpg" %}
...
{% include image.html description="Horse statue" url="/resources/us_roadtrip/nashville/horse.jpg" %}
...
{% include image.html description="Blues" url="/resources/us_roadtrip/nashville/blues.jpg" %}
...
{% include image.html description="Words" url="/resources/us_roadtrip/nashville/words.jpg" %}
...
<div class="ui center aligned segment">
  <div class="ui list">
    <div class="item">I saw the best minds of my generation</div>
    <div class="item">Destroyed by madness, starving, hysterical, naked</div>
    <div class="item">Dragging themselves to the suburbs at dusk, looking for an angry fix</div>
    <div class="item">Who bared their brains to Heaven under the El</div>
    <div class="item">And saw Mohammedan angels staggering on tenement rooftops illuminated</div>
    <div class="item">Who cowered in unshaven rooms in three sweaters, burning their money in wastebaskets</div>
    <div class="item">And listening to Koreans through the wall,</div>
    <div class="item">Who ate gyros in paint hostels or drank beer in airport bathrooms,</div>
    <div class="item">Who chained themselves to subways for the endless ride from Halstead to Southport to the Navy Pier</div>
    <div class="item">Who talked continuously seventy hours from park to pad to bar to Presidents to museum to the Lake Street Bridge</div>
    <div class="item">What sphinx of cement and aluminum walked miles upon miles and ate up their legs?</div>
    <div class="item">Chicago! Whose theaters are very numerous!</div>
    <div class="item">Chicago! Whose Chinatown is the spectre of genius!</div>
    <div class="item">Chicago! Chicago! Whose trains ride overhead!</div>
    <div class="item">Real holy laughter in the river! They saw it all! The wild eyes! The holy yells! They bade farewell! They jumped off the roof! To solitude! waving! Carrying Flowers! Down to the river! Into the street!</div>
  </div>
</div>
...
{% include image.html description="Smiley face" url="/resources/us_roadtrip/chicago/window.jpg" %}
...
{% include image.html description="Fountain" url="/resources/us_roadtrip/chicago/fountain.jpg" %}
...
{% include image.html description="Bean" url="/resources/us_roadtrip/chicago/bean.jpg" %}
...
{% include image.html description="Spiderman" url="/resources/us_roadtrip/chicago/spiderman.jpg" %}
...
{% include image.html description="Arttttttt" url="/resources/us_roadtrip/chicago/art.jpg" %}
...
{% include image.html description="Bridge (cool photo)" url="/resources/us_roadtrip/chicago/bridge.jpg" %}
...
{% include image.html description="Friend-ou" url="/resources/us_roadtrip/chicago/friends.jpg" %}
...
{% include image.html description="Bull" url="/resources/us_roadtrip/chicago/bull.jpg" %}
...
{% include image.html description="Boy" url="/resources/us_roadtrip/chicago/boy.jpg" %}
...
<div class="ui center aligned segment">
  <div class="ui list">
    <div class="item">Two roads diverged in a mellow hood,</div>
    <div class="item">And sorry I could not walk the two,</div>
    <div class="item">In real fact, I probably could,</div>
    <div class="item">Though at the hostel long I stood,</div>
    <div class="item">My undone work, long to rue</div>
    <div class="item">The Island park, with beaches fair</div>
    <div class="item">Little ducks, in mothers' wings</div>
    <div class="item">The wind was cold, and blew our hair</div>
    <div class="item">No one nude on beaches there</div>
    <div class="item">Instead quiescing on the swings</div>
    <div class="item">Then to the other, Chinatown</div>
    <div class="item">Two miles north, my feet are sore</div>
    <div class="item">For many steps have worn the ground</div>
    <div class="item">Speaking Chinese all around</div>
    <div class="item">And spicy snails we then devore</div>
    <div class="item">We wanted all the sights to see</div>
    <div class="item">But the metro made no sense</div>
    <div class="item">Two roads diverged in a hood, and we -</div>
    <div class="item">We took them both, because fuck me</div>
    <div class="item">And that has made all the difference</div>
  </div>
</div>
...
{% include image.html description="Graffiti" url="/resources/us_roadtrip/toronto/graphiti.jpg" %}
...
{% include image.html description="At the park" url="/resources/us_roadtrip/toronto/park_both.jpg" %}
...
{% include image.html description="Sunset" url="/resources/us_roadtrip/toronto/sunset.jpg" %}
...
{% include image.html description="Captain America (actually in Reagan airport on the way back to Atlanta, but semantics)" url="/resources/us_roadtrip/washington/captain_america.jpg" %}
...
{% include image.html description="Arttttttttttttttttttttttttttttttt" url="/resources/us_roadtrip/washington/other_statue.jpg" %}
...
{% include image.html description="Arttttttttttttttttt" url="/resources/us_roadtrip/washington/statue.jpg" %}
