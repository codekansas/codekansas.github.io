...
{% katex display %}\frac{x y^T}{||x|| ||y||}{% endkatex %}
...
{% katex display %}(\gamma x y^T + c)^d{% endkatex %}
...
{% katex display %}\tanh(\gamma x y^T + c){% endkatex %}
...
{% katex display %}\exp(-\gamma ||x - y||^2){% endkatex %}
...
{% katex display %}\frac{1}{1 + ||x - y||}{% endkatex %}
...
{% katex display %}\exp(-\gamma ||x - y||){% endkatex %}
...
{% katex display %}\frac{1}{1 + ||x - y||} * \frac{1}{1 + \exp(-\gamma (x y^T + c))}{% endkatex %}
...
{% katex display %}\frac{0.5}{1 + ||x - y||} + \frac{0.5}{1 + \exp(-\gamma (x y^T + c))}{% endkatex %}
...
{% katex display %}MRR = \frac{1}{|Q|} \sum_{i=1}^{|Q|}{\frac{1}{rank_i}}{% endkatex %}
