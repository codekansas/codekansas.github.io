...
{% include image.html description="Word distributions in vector space. The word distributions are learned so that the red people, Sarah and Sam, are in one part of the space, and the green people, Bob and Hannah, are in another part." url="/assets/pics/posts/language/word_vectors.png" %}
...
{% include image.html description="Recurrent neural network architectures, from <a href='http://karpathy.github.io/2015/05/21/rnn-effectiveness/'>Andrej Karpathy's blog</a>." url="/assets/pics/posts/language/karpathy_rnn.jpeg" %}
...
{% include image.html description="This surprisingly simple model performed very well on the task." url="/assets/pics/posts/language/model_diagram.jpeg" %}
